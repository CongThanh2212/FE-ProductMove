...
class StatusStatistical extends React.Component {
    ...
    year() {
        ...
        xmlHttp.open('GET', URL + '/agent/statistical-import-by-year?agentId=' + this.props.id, false);
        xmlHttp.send(null);
    }
    ...
    componentDidMount() {
        ...
        xmlHttp.open('GET', URL + '/agent/statistical-import-by-month?agentId=' + this.props.id, false);
        xmlHttp.send(null);
    }
        ...
        return (
            <Fragment>
                <div className="createAccount">
                    <h1>Thống kê sản phẩm nhập về</h1>
                </div>
...
export default StatusStatistical