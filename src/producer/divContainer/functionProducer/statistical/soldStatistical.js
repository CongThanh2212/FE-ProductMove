...
class SoldStatistical extends React.Component {
    ...
    year() {
        ...
        xmlHttp.open('GET', URL + '/producer/statistical-export-by-year?producerId=' + this.props.id, false);
        xmlHttp.send(null);
    }
    ...
    componentDidMount() {
        ...
        xmlHttp.open('GET', URL + '/producer/statistical-export-by-month?producerId=' + this.props.id, false);
        xmlHttp.send(null);
    }
